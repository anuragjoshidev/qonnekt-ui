...
type InputGroupSelectProps = Pick<
  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        data-slot="input-group-control"
        className={cn(
          "h-9 w-full min-w-0 rounded-none border-0 bg-transparent px-3 py-1 text-sm shadow-none",
      ...
      <SelectContent
        position="popper"
        className={cn("z-[60]", contentClassName)}
      >
        {children}
      </SelectContent>
    </Select>
...
export type { InputGroupSelectProps };
